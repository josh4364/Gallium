...
- [ ] **Action**: Implement a horizontal plane at the bottom of the layout (spanning the width).
- [ ] **Functionality**:
...
- [ ] **Action**: Implement a modal or overlay view for System Settings.
- [ ] **Features**:
...
3. [ ] **Navigation Test**: Verify arrow keys navigate the File Browser and settings can be toggled.
